...
- **Handwritten ABI tracing:** bootstrap, common, logging, Platform, Connect, Auth, P2P, and Presence
  are covered (150 of 356 handwritten exports). Calls rejected before dispatch remain visible; synchronous
  results use typed return values; asynchronous calls retain one correlation through callback
