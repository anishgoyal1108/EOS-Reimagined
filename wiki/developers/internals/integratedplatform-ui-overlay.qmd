---
title: "Modules: `EOSSDK_IntegratedPlatform` (+ Container), `EOSSDK_UI`, Overlay"
---
...
- **Container** (options container, passed to `EOS_Platform_Create`; see `client.qmd` Init reading the IntegratedPlatformOptionsContainer): `Add` @`0x1800ceaf0`, `GetEntry` @`0x1800cee70`, `GetEntryCount` @`0x1800cede0`, `Release` @`0x1800cf010`. Created via `EOS_IntegratedPlatformOptionsContainer_*` flat API.
...
join surface is the social overlay; see [companion-client.md](companion-client.qmd). It does not make
