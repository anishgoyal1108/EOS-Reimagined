---
title: "ADR 0001 — Authenticated Mesh Identity"
---

Status: **accepted, in progress** (2026-07-13). Supersedes the "self-asserted identity" limitation recorded in `progress.qmd` under the frozen foundation.
