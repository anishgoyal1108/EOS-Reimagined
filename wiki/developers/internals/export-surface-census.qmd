---
title: "Export-surface census"
---

::: {.callout-note}
## Historical measurement — the gap below is now shelled

This census (356 exports, 22 absent families) is the measurement that motivated the
full-surface milestone. As of 2026-07-14 every declared EOS export exists — **638** in total —
with the previously-absent families generated as honest `EOS_NotImplemented` shells by
`tools/gen_stubs.py`. The analysis below is preserved as the rationale; for what actually
*functions*, see the [roadmap](../../users/roadmap.qmd).
:::
