...
5. Instrument one vertical slice first — `EOS_Initialize` → `EOS_Platform_Create` → one asynchronous
   ...
   - **Also done:** 150 handwritten bootstrap, common, logging, Platform, Connect, Auth, P2P, and
     Presence exports.
     ...
     fabricated delivery.
   - **Still to do:** the remaining 206 handwritten interface exports using the same trampoline
     pattern.
