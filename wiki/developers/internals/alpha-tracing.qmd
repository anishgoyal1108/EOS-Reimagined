...
5. Instrument one vertical slice first — `EOS_Initialize` → `EOS_Platform_Create` → one asynchronous
   ...
   - **Also done:** 131 handwritten bootstrap, common, logging, Platform, Connect, Auth, and P2P
     exports.
     ...
     tracer.
   - **Still to do:** the remaining 225 handwritten interface exports using the same trampoline
     pattern.
