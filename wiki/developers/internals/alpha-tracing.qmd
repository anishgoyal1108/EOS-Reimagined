...
5. Instrument one vertical slice first — `EOS_Initialize` → `EOS_Platform_Create` → one asynchronous
   ...
   - **Also done:** 277 handwritten bootstrap, common, logging, Platform, Connect, Auth, P2P,
     Sessions, Presence, IntegratedPlatform, Friends, UserInfo, and UI exports.
   ...
   - **Still to do:** the remaining 79 handwritten Lobby exports using the same trampoline pattern.
