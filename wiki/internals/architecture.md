...
> Reverse-engineered from `EOSSDK-Win64-Shipping.dll` (the reference EOS emulator, ~EOS SDK 1.17.1), cross-checked against its surviving 2020 GPL source. This document is the behavioral spec for the portable FOSS reimplementation.
...
| `Settings` | Parsed `eos_reimagined.json` |
