...
**Tier B (no 2020 source).** Platform-integration bridge + the social overlay control surface. 8 + 4 + 27 methods (+ the `overlay/EpicOverlay.cpp` module).
...
## `EOSSDK_UI` (27) — social overlay control
