...
// Spec: UDP discovery (wiki/developers/internals/protocol.qmd)
struct net_config {
...
// Spec: Network (wiki/developers/internals/protocol.qmd), authenticated mesh (wiki/developers/internals/adr/0001)
