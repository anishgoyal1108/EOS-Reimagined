...
// A parsed eosr.json reduced to the shapes config reads: a string, an integer, an array of integers,
// or "some other JSON type" (an object, a bool, a fractional number, an array with a non-integer in
