...
// Spec: identity binding (wiki/developers/internals/adr/0001 §11)
...
// Spec: no downgrade (wiki/developers/internals/adr/0001 §8, §11)
...
// Spec: replay window (wiki/developers/internals/adr/0001 §7, §11)
